...
_TARGET_FILE = os.path.join(_MLOPS_DIR, "continuous_learning.py")
...
spec = importlib.util.spec_from_file_location("_backend_continuous_learning", _TARGET_FILE)
_mod = importlib.util.module_from_spec(spec)
sys.modules["continuous_learning"] = _mod
